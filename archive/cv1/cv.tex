...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
	\resumeItem {Responsible for building a large part of the company's trading platform, including: CI/CD (Jenkins, Docker, Kubernetes) and ETL (Apache Airflow, Python)}
        \resumeItem {Responsible for development of key trading tools, including an interpreter for a domain specific language which we used to express our trading strategies using Python and Pandas}
